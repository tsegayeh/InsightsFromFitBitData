...
<ul>
   Alerts – to remind users, e.g., starting times of fitness activities <br />
   Notification – to notify performance status, e.g., attended or missed fitness activity <br />
